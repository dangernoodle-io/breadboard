...
smoke: smoke-elecrow-p4-hmi7 smoke-arduino-uno-cc3000 smoke-arduino-uno-r4-wifi smoke-esp32-wroom-32
...
smoke-arduino-uno-r4-wifi: ## Build Arduino Uno R4 WiFi example
	cp examples/arduino-uno-r4-wifi/include/secrets.h.example examples/arduino-uno-r4-wifi/include/secrets.h
	$(PIO) run -d examples/arduino-uno-r4-wifi -e uno_r4_wifi
