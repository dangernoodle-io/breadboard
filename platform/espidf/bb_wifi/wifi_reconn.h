...
// component; not a public API. reason is passed through explicitly rather
// than read back via bb_wifi_get_disconnect() -- see bb_wifi_net_event_fn's
// doc comment in bb_wifi.h for the staleness race this avoids.
