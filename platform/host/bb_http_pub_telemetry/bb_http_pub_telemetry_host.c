// bb_http_pub_telemetry host twin — section get/patch logic + test hooks.
...
#if CONFIG_BB_HTTP_PUB_TELEMETRY_AUTOREGISTER
BB_REGISTRY_REGISTER_PRE_HTTP(bb_http_pub_telemetry, bb_http_pub_telemetry_init);
#endif
