...
Regenerates the GENERATED marker regions inside component READMEs.
...
New component READMEs (and `bb_attrs` / `bb_filter`, ported as the first two
examples) follow this section skeleton:
...
See [`include/bb_<name>.h`](include/bb_<name>.h). Key symbols: ...

A generated C API reference site (Doxygen+MkDocs) is future work — tracked as B1-348.

## Config knobs

<HAND — Kconfig-driven generation is a later fork; hand-document known knobs here>
