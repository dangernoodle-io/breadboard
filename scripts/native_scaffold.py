...
COMPONENT_MAP = {
    ...
    "bb_str": {
        ...
        "sources":  ["platform/host/bb_str/bb_str.c"],
        "depends":  [],
    },
    "bb_scalar": {
        "includes": ["components/bb_scalar/include"],
    ...
    "bb_fmt": {
        "includes": ["components/bb_fmt/include"],
        "sources":  ["platform/host/bb_fmt/bb_fmt.c"],
        "depends":  [],
    },
    "bb_event_ring": {
