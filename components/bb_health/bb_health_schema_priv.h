...
//
// bb_response_assemble_schema(reg, k_health_base, k_health_suffix) builds the
...
// Named sections (mqtt, temp, ...) are emitted by bb_response_assemble_schema
// from each section's schema_props string.
//
// NOTE: bb_response_assemble_schema detects that base ends with non-'{' content
...
// by bb_response_assemble_schema with commas. Suffix closes the properties object
