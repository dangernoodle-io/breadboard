#pragma once
// Test-only hooks for bb_ring. Gated on BB_RING_TESTING so production builds
// never compile against them. Tests include this header instead of reaching
// into bb_ring.c internals.
...
// bb_ring_test_force_bytes_used — directly overwrite the internal bytes_used
...
// bb_ring_pop_oldest()/bb_ring_push() without relying on a real bug to exist.
