...
// consumer can compose bb_system's primitives (reboot-reason SSOT, boot
// banner, boot-fail counters, bb_system_snap) without inheriting the HTTP
// route surface. Include bb_system_routes.h directly for those symbols.
