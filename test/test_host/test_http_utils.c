...
{
    char out[256];
    bsp_url_decode_field("ssid=TestNetwork&pass=secret", "ssid", out, sizeof(out));
...
{
    char out[256];
    bsp_url_decode_field("ssid=Test+Network", "ssid", out, sizeof(out));
...
{
    char out[256];
    bsp_url_decode_field("pass=hello%21world", "pass", out, sizeof(out));
...
{
    char out[256];
    bsp_url_decode_field("ssid=TestNetwork", "pass", out, sizeof(out));
...
{
    char out[5];
    bsp_url_decode_field("ssid=abcdefghij", "ssid", out, sizeof(out));
...
{
    char out[256];
    bsp_url_decode_field("f=abc%2", "f", out, sizeof(out));
    TEST_ASSERT_EQUAL_STRING("abc%2", out);
}

void test_bsp_url_decode_field_not_first(void)
{
    char out[256];
    bsp_url_decode_field("a=1&b=2&c=3", "b", out, sizeof(out));
...
{
    char out[256];
    bsp_url_decode_field("ssid=&pass=secret", "ssid", out, sizeof(out));
    TEST_ASSERT_EQUAL_STRING("", out);
}
...
{
    char out[256];
    bsp_url_decode_field("a=1&b=2", "b", out, sizeof(out));
    TEST_ASSERT_EQUAL_STRING("2", out);
}

void test_bsp_url_decode_field_at_end(void)
{
    char out[256];
    bsp_url_decode_field("a=1&b=2", "b", out, sizeof(out));
    TEST_ASSERT_EQUAL_STRING("2", out);
...
void test_prov_parse_empty_body(void)
{
    ...
    bsp_prov_parse_result_t result = bsp_prov_parse_body("", 0, ssid, sizeof(ssid), pass, sizeof(pass));
    TEST_ASSERT_EQUAL(BSP_PROV_PARSE_EMPTY_BODY, result);
}
...
void test_prov_parse_missing_ssid(void)
{
    ...
    bsp_prov_parse_result_t result = bsp_prov_parse_body(body, strlen(body), ssid, sizeof(ssid), pass, sizeof(pass));
    TEST_ASSERT_EQUAL(BSP_PROV_PARSE_SSID_REQUIRED, result);
}
...
void test_prov_parse_ssid_only(void)
{
    ...
    bsp_prov_parse_result_t result = bsp_prov_parse_body(body, strlen(body), ssid, sizeof(ssid), pass, sizeof(pass));
    TEST_ASSERT_EQUAL(BSP_PROV_PARSE_OK, result);
