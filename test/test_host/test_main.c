...
int main(void) {
    ...
    RUN_TEST(test_manifest_register_nv_duplicate_key_in_shared_namespace_returns_err);
    RUN_TEST(test_manifest_register_nv_shared_namespace_different_keys_both_emitted);
    RUN_TEST(test_manifest_register_nv_two_callers_different_namespaces);
