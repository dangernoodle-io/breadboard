...
int main(void) {
    ...
    RUN_TEST(test_bb_data_http_client_acquire_is_ws_true_sets_is_ws_flag);
    RUN_TEST(test_bb_data_http_client_acquire_is_ws_false_clears_is_ws_flag);
    RUN_TEST(test_bb_data_http_client_is_ws_for_test_null_client_returns_false);
    RUN_TEST(test_bb_data_http_client_acquire_fd_zero_is_accepted_as_a_real_descriptor);
    RUN_TEST(test_bb_data_http_client_acquire_no_fd_sentinel_is_accepted);
    RUN_TEST(test_bb_data_http_client_acquire_negative_non_sentinel_fd_returns_invalid_arg);
