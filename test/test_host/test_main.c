...
// Forward declarations from test_bb_ring_registry.c
...
int main(void) {
    ...
    RUN_TEST(test_bb_init_early_honors_order_priority);
    RUN_TEST(test_bb_init_early_same_order_preserves_insertion_order);
    RUN_TEST(test_bb_init_early_order_mixed);
    RUN_TEST(test_bb_init_early_default_order_zero_runs_in_registration_order);
    RUN_TEST(test_bb_init_pre_http_honors_order_priority);
    RUN_TEST(test_bb_init_pre_http_same_order_preserves_insertion_order);
    RUN_TEST(test_bb_init_pre_http_order_mixed);
    RUN_TEST(test_bb_init_pre_http_default_order_zero_runs_in_registration_order);
    RUN_TEST(test_bb_init_init_sorts_pre_http_when_not_yet_walked);
    RUN_TEST(test_bb_init_init_sorts_pre_http_reports_error_when_not_yet_walked);
    RUN_TEST(test_bb_init_add_null_entry_is_noop);
    RUN_TEST(test_bb_init_add_early_null_entry_is_noop);
    RUN_TEST(test_bb_init_add_pre_http_null_entry_is_noop);
    RUN_TEST(test_bb_init_foreach_null_cb_is_noop);
    RUN_TEST(test_bb_init_foreach_early_null_cb_is_noop);
    RUN_TEST(test_bb_init_foreach_pre_http_null_cb_is_noop);
    RUN_TEST(test_bb_init_foreach_empty_visits_none);
    RUN_TEST(test_bb_init_foreach_early_empty_visits_none);
    RUN_TEST(test_bb_init_foreach_pre_http_empty_visits_none);
    RUN_TEST(test_bb_init_init_regular_second_error_does_not_overwrite_first);
    RUN_TEST(test_bb_init_early_second_error_does_not_overwrite_first);
    RUN_TEST(test_bb_init_pre_http_standalone_second_error_does_not_overwrite_first);
    RUN_TEST(test_bb_init_init_pre_http_embedded_second_error_does_not_overwrite_first);
    RUN_TEST(test_bb_init_init_collector_cap_at_256_regular_entries);
    RUN_TEST(test_bb_init_early_collector_cap_at_256_entries);
    RUN_TEST(test_bb_init_pre_http_collector_cap_at_256_entries_standalone);
    RUN_TEST(test_bb_init_init_collector_cap_at_256_pre_http_entries_embedded);
    RUN_TEST(test_bb_init_pre_http_standalone_double_call_is_noop_second_time);
    RUN_TEST(test_bb_init_add_regular_malloc_null_is_noop);
    RUN_TEST(test_bb_init_add_early_malloc_null_is_noop);
    RUN_TEST(test_bb_init_add_pre_http_malloc_null_is_noop);
    RUN_TEST(test_bb_init_early_init_empty_is_noop);
    RUN_TEST(test_bb_init_pre_http_init_empty_is_noop);
    RUN_TEST(test_bb_init_init_all_empty_is_noop);
    ...
    RUN_TEST(test_bb_ring_bytes_used_empty_ring_is_zero);
    RUN_TEST(test_bb_ring_bytes_used_clamps_on_pop_underflow);
    RUN_TEST(test_bb_ring_bytes_used_clamps_on_evict_underflow);
    ...
    // bb_ring_registry tests
    RUN_TEST(test_bb_ring_registry_register_deregister_roundtrip);
    RUN_TEST(test_bb_ring_registry_deregister_by_value_removes_correct_entry);
    RUN_TEST(test_bb_ring_registry_register_null_args_returns_invalid_arg);
    RUN_TEST(test_bb_ring_registry_deregister_null_returns_invalid_arg);
    RUN_TEST(test_bb_ring_registry_deregister_unregistered_returns_not_found);
    RUN_TEST(test_bb_ring_registry_overflow_returns_no_space);
    RUN_TEST(test_bb_ring_registry_duplicate_name_returns_invalid_state);
    RUN_TEST(test_bb_ring_registry_create_auto_registers);
    RUN_TEST(test_bb_ring_registry_destroy_auto_deregisters);
    RUN_TEST(test_bb_ring_registry_destroy_then_recreate_reregisters);
    RUN_TEST(test_bb_ring_registry_destroy_null_noop);
    RUN_TEST(test_bb_ring_registry_foreach_visits_all_with_fields);
