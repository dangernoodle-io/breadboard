...
// Forward declarations from test_bb_wifi_http_scan_wire_meta_golden.c
// (B1-1059 PR-3 prework) -- the POST /api/wifi/scan RESPONSE descriptor
// (distinct from test_bb_wifi_http_wire_meta_golden.c's GET-side response).
...
// Forward declarations from test_bb_diag_boot_topic_schema_default.c,
// test_bb_health_stack_topic_schema_default.c,
// test_bb_log_event_line_topic_schema_default.c,
// test_bb_ota_hooks_topic_schema_default.c (B1-1059 SSE batch PR-3,
// config-OFF byte-identity proofs)
...
// register_assets cfg->fallback tests (B1-1458)
...
// Forward declarations from test_wifi_prov_policy.c (B1-809 PR2/PR3a)
...
int main(void) {
    ...
    RUN_TEST(test_route_registry_strict_trap_fires_on_overflow);
    RUN_TEST(test_route_registry_strict_trap_does_not_fire_when_strict_disabled);
    RUN_TEST(test_route_registry_watermark_warn_fires_once_at_cap_minus_8);
    RUN_TEST(test_uri_strip_query_copy_rejects_null_uri);
    RUN_TEST(test_uri_strip_query_copy_rejects_null_out);
    RUN_TEST(test_uri_strip_query_copy_rejects_zero_cap);
    RUN_TEST(test_uri_strip_query_copy_accepts_valid_args);
    ...
    // register_assets cfg->fallback tests (B1-1458)
    RUN_TEST(test_register_assets_fallback_no_match_invokes_fallback);
    RUN_TEST(test_register_assets_fallback_match_does_not_invoke_fallback);
    RUN_TEST(test_register_assets_fallback_omitted_preserves_404);
    RUN_TEST(test_register_assets_null_assets_n_zero_with_fallback_ok);
    RUN_TEST(test_register_assets_null_assets_n_zero_no_fallback_ok);
    RUN_TEST(test_register_assets_null_assets_n_nonzero_invalid_arg);
    RUN_TEST(test_register_assets_null_cfg_invalid_arg);
    RUN_TEST(test_register_assets_entry_with_null_field_rejected);
    RUN_TEST(test_register_assets_entry_with_null_mime_rejected);
    RUN_TEST(test_register_assets_entry_with_null_data_rejected);
    ...
    RUN_TEST(test_openapi_emit_stream_route_null_summary_omitted);
    RUN_TEST(test_openapi_emit_stream_param_count_zero_omits_parameters);
    RUN_TEST(test_openapi_emit_stream_param_null_description_and_schema_type_omitted);
    RUN_TEST(test_openapi_emit_stream_param_null_name_and_in_default);
    RUN_TEST(test_openapi_emit_stream_request_schema_without_content_type_defaults_to_json);
    RUN_TEST(test_openapi_emit_stream_response_null_description_defaults_to_empty);
    ...
    RUN_TEST(test_sse_schema_union_seam_dedup_collision_legacy_wins);
    RUN_TEST(test_sse_schema_union_seam_external_vs_external_collision);
    RUN_TEST(test_sse_schema_union_seam_wired_produces_valid_document);
    RUN_TEST(test_sse_schema_dangling_ref_oracle_detects_missing_schema_body);
    ...
    RUN_TEST(test_sse_schema_log_event_describe_matches_legacy_and_golden);
    RUN_TEST(test_sse_schema_ota_hooks_describe_matches_legacy_and_golden);
    RUN_TEST(test_sse_schema_health_stack_describe_matches_legacy_and_golden);
    RUN_TEST(test_sse_schema_diag_boot_describe_matches_legacy_and_golden);
    RUN_TEST(test_sse_schema_display_info_describe_matches_legacy_and_golden);
    RUN_TEST(test_sse_schema_ota_check_describe_matches_legacy_and_golden);
    ...
    RUN_TEST(test_bb_system_reboot_record_save_retry_first_attempt_succeeds_no_retry);
    RUN_TEST(test_bb_system_reboot_record_save_retry_first_fails_second_succeeds);
    RUN_TEST(test_bb_system_reboot_record_save_retry_both_attempts_fail_returns_error);
    ...
    // wifi_prov_policy tests (B1-809 PR2/PR3a)
    ...
    RUN_TEST(test_wifi_prov_save_success_enters_closing_without_teardown);
    RUN_TEST(test_wifi_prov_settle_timeout_closes_portal_in_order);
    RUN_TEST(test_wifi_prov_closing_save_success_is_noop);
    RUN_TEST(test_wifi_prov_closing_entry_user_requested_is_noop);
    RUN_TEST(test_wifi_prov_idle_settle_timeout_is_noop);
    RUN_TEST(test_wifi_prov_active_settle_timeout_is_noop);
    ...
    RUN_TEST(test_wifi_prov_fsm_init_clamps_zero_settle_ms_to_one);
    ...
    RUN_TEST(test_wifi_prov_active_sets_prov_active_signal);
    RUN_TEST(test_wifi_prov_closing_does_not_clear_prov_active_signal);
    RUN_TEST(test_wifi_prov_idle_clears_prov_active_signal);
    ...
    RUN_TEST(test_bb_task_resolve_core_owning_with_core_any_returns_invalid_arg);
    RUN_TEST(test_bb_task_resolve_core_owning_already_claimed_core_returns_invalid_arg);
    RUN_TEST(test_bb_task_resolve_non_owning_pin_on_claimed_core_still_resolves);
    RUN_TEST(test_bb_task_resolve_core_owning_different_core_still_resolves);
    RUN_TEST(test_bb_task_resolve_steers_around_claimed_core0);
    RUN_TEST(test_bb_task_resolve_steers_around_claimed_core1);
    ...
    RUN_TEST(test_bb_task_base_set_free_bytes_null_handle_returns_invalid_arg);
    RUN_TEST(test_bb_task_base_set_free_bytes_unregistered_returns_not_found);
    RUN_TEST(test_bb_task_base_set_free_bytes_updates_free_bytes_not_other_fields);
    RUN_TEST(test_bb_task_base_set_core_owning_null_handle_returns_invalid_arg);
    RUN_TEST(test_bb_task_base_set_core_owning_unregistered_returns_not_found);
    RUN_TEST(test_bb_task_base_set_core_owning_updates_fields_not_others);
    RUN_TEST(test_bb_task_base_upserted_task_reports_unsampled_until_set_free_bytes);
    ...
    RUN_TEST(test_bb_task_registry_base_scan_apply_updates_free_bytes_across_scans);
    ...
    RUN_TEST(test_bb_task_create_core_owning_claims_and_deregister_releases);
    RUN_TEST(test_bb_task_create_second_owning_claim_on_same_core_rejected);
    RUN_TEST(test_bb_task_create_core_owning_degrades_to_noop_claim_on_unicore);
    RUN_TEST(test_bb_task_deregister_non_owning_task_does_not_touch_wdt);
    RUN_TEST(test_bb_task_create_core_owning_releases_claim_when_base_registry_full);
    ...
    RUN_TEST(test_bb_wdt_subscribe_cfg_null_is_invalid_arg);
    RUN_TEST(test_bb_wdt_unsubscribe_cfg_null_is_invalid_arg);
    RUN_TEST(test_bb_wdt_subscribe_handle_increments_counter);
    RUN_TEST(test_bb_wdt_unsubscribe_handle_increments_counter);
    RUN_TEST(test_bb_wdt_subscribe_omitted_handle_matches_pre_collapse_base_call);
    RUN_TEST(test_bb_wdt_unsubscribe_omitted_handle_matches_pre_collapse_base_call);
    RUN_TEST(test_bb_wdt_task_subscribe_unsubscribe_default_cfg_counters);
    RUN_TEST(test_bb_wdt_subscribe_handle_distinguishes_from_null);
    RUN_TEST(test_bb_wdt_claim_core_sets_bit);
    RUN_TEST(test_bb_wdt_claim_core_1_sets_bit);
    RUN_TEST(test_bb_wdt_claim_core_both_accumulates);
    RUN_TEST(test_bb_wdt_claim_core_idempotent_same_core);
    RUN_TEST(test_bb_wdt_claim_core_invalid_arg);
    RUN_TEST(test_bb_wdt_release_core_clears_bit);
    RUN_TEST(test_bb_wdt_release_core_1_clears_bit);
    RUN_TEST(test_bb_wdt_release_core_unclaimed_is_ok);
    RUN_TEST(test_bb_wdt_release_core_invalid_arg);
    RUN_TEST(test_bb_wdt_claim_core_exclusive_sets_bit_on_first_claim);
    RUN_TEST(test_bb_wdt_claim_core_exclusive_1_sets_bit_on_first_claim);
    RUN_TEST(test_bb_wdt_claim_core_exclusive_rejects_already_claimed);
    RUN_TEST(test_bb_wdt_claim_core_exclusive_rejects_claimed_via_plain_claim);
    RUN_TEST(test_bb_wdt_claim_core_exclusive_other_core_still_succeeds);
    RUN_TEST(test_bb_wdt_claim_core_exclusive_invalid_arg);
    RUN_TEST(test_bb_wdt_claim_core_exclusive_after_release_succeeds_again);
    RUN_TEST(test_bb_wdt_test_reset_clears_claims);
    RUN_TEST(test_bb_wdt_derive_excused_mask_zero_zero);
    RUN_TEST(test_bb_wdt_derive_excused_mask_seed_only);
    RUN_TEST(test_bb_wdt_derive_excused_mask_claimed_only);
    RUN_TEST(test_bb_wdt_derive_excused_mask_union_never_overrides);
    RUN_TEST(test_bb_wdt_derive_excused_mask_both_same_bit_is_idempotent);
    RUN_TEST(test_bb_wdt_derive_excused_mask_both_full);
    RUN_TEST(test_bb_wdt_clamp_core_mask_dual_core_unchanged);
    RUN_TEST(test_bb_wdt_clamp_core_mask_unicore_drops_bit1);
    RUN_TEST(test_bb_wdt_clamp_core_mask_unicore_only_bit1_clamps_to_zero);
    RUN_TEST(test_bb_wdt_clamp_core_mask_zero_cores_clamps_to_zero);
    RUN_TEST(test_bb_wdt_clamp_core_mask_negative_cores_clamps_to_zero);
    RUN_TEST(test_bb_wdt_clamp_core_mask_large_num_cores_unchanged);
    RUN_TEST(test_bb_wdt_invert_core_mask_core0_excused_yields_core1_monitored);
    RUN_TEST(test_bb_wdt_invert_core_mask_nothing_excused_yields_all_monitored);
    RUN_TEST(test_bb_wdt_invert_core_mask_everything_excused_yields_nothing_monitored);
    RUN_TEST(test_bb_wdt_invert_core_mask_self_inverse);
    RUN_TEST(test_bb_wdt_invert_core_mask_unicore_only_bit0_in_range);
    RUN_TEST(test_bb_wdt_pipeline_kconfig_yy_plus_claim_core0_yields_core1_monitored);
    RUN_TEST(test_bb_wdt_pipeline_claim_on_kconfig_already_unmonitored_core_is_noop);
    RUN_TEST(test_bb_wdt_pipeline_both_cores_claimed_yields_nothing_monitored);
    RUN_TEST(test_bb_wdt_claim_core_1_on_unicore_never_produces_out_of_range_mask);
    RUN_TEST(test_bb_wdt_claim_core_1_on_unicore_does_not_poison_later_reconfigure);
    RUN_TEST(test_bb_wdt_set_timeout_does_not_clobber_claim);
    RUN_TEST(test_bb_wdt_release_core_reconfigures_immediately);
    RUN_TEST(test_bb_wdt_steer_core_explicit_pin_0_passes_through);
    RUN_TEST(test_bb_wdt_steer_core_explicit_pin_1_passes_through);
    RUN_TEST(test_bb_wdt_steer_core_any_steers_away_from_claimed_core0);
    RUN_TEST(test_bb_wdt_steer_core_any_steers_away_from_claimed_core1);
    RUN_TEST(test_bb_wdt_steer_core_any_zero_claimed_unchanged);
    RUN_TEST(test_bb_wdt_steer_core_any_both_claimed_unchanged);
    RUN_TEST(test_bb_wdt_steer_core_unicore_any_unchanged);
    RUN_TEST(test_bb_wdt_steer_core_unicore_explicit_pin_unchanged);
    RUN_TEST(test_bb_wdt_steer_core_other_value_passes_through);
    ...
    RUN_TEST(test_bb_mqtt_enqueue_null_handle_returns_invalid_arg);
    RUN_TEST(test_bb_mqtt_enqueue_null_topic_returns_invalid_arg);
    RUN_TEST(test_bb_mqtt_enqueue_while_disconnected_still_accepted);
    RUN_TEST(test_bb_mqtt_enqueue_accepted_returns_ok_and_records_pub);
    RUN_TEST(test_bb_mqtt_enqueue_outbox_full_returns_no_space);
    RUN_TEST(test_bb_mqtt_enqueue_generic_reject_returns_validation);
    RUN_TEST(test_bb_mqtt_enqueue_msg_id_hook_is_sticky);
    RUN_TEST(test_bb_mqtt_enqueue_count_null_handle_returns_zero);
    RUN_TEST(test_bb_mqtt_enqueue_set_msg_id_null_handle_is_safe);
    RUN_TEST(test_bb_mqtt_enqueue_ring_overflow_evicts_oldest);
    RUN_TEST(test_bb_mqtt_enqueue_null_payload_is_safe);
    RUN_TEST(test_bb_mqtt_enqueue_explicit_len);
    RUN_TEST(test_bb_mqtt_enqueue_truncates_oversized_payload);
    RUN_TEST(test_bb_mqtt_enqueue_qos0_store_false_returns_validation);
    RUN_TEST(test_bb_mqtt_enqueue_qos1_store_false_still_accepted);
    RUN_TEST(test_bb_mqtt_enqueue_qos0_store_true_is_accepted);
    RUN_TEST(test_bb_mqtt_enqueue_qos0_store_false_outbox_full_hook_still_no_space);
    RUN_TEST(test_bb_mqtt_enqueue_set_store_null_handle_is_safe);
    RUN_TEST(test_bb_mqtt_enqueue_set_outbox_limit_null_handle_is_safe);
    RUN_TEST(test_bb_mqtt_enqueue_outbox_limit_reached_returns_no_space);
    RUN_TEST(test_bb_mqtt_enqueue_outbox_limit_zero_is_unbounded);
    RUN_TEST(test_bb_mqtt_enqueue_outbox_limit_reachable_again_after_drain);
    RUN_TEST(test_bb_mqtt_enqueue_drain_outbox_floors_at_zero);
    RUN_TEST(test_bb_mqtt_enqueue_drain_outbox_null_handle_is_safe);
    RUN_TEST(test_bb_mqtt_publish_qos1_outbox_limit_reached_returns_no_space);
    RUN_TEST(test_bb_mqtt_publish_qos0_ignores_outbox_limit);
    RUN_TEST(test_bb_mqtt_publish_null_payload_qos1_is_safe);
    RUN_TEST(test_bb_mqtt_enqueue_len_zero_measures_via_strlen_against_outbox_limit);
    RUN_TEST(test_bb_mqtt_publish_len_zero_measures_via_strlen_against_outbox_limit);
    RUN_TEST(test_bb_mqtt_enqueue_then_publish_share_outbox_limit);
    RUN_TEST(test_bb_mqtt_publish_then_enqueue_share_outbox_limit);
    RUN_TEST(test_bb_mqtt_init_null_uri_is_safe);
    RUN_TEST(test_bb_mqtt_publish_null_topic_returns_invalid_arg);
    RUN_TEST(test_bb_mqtt_publish_truncates_oversized_payload);
    RUN_TEST(test_bb_mqtt_get_stats_null_handle_returns_invalid_arg);
    RUN_TEST(test_bb_mqtt_get_stats_null_out_returns_invalid_arg);
    RUN_TEST(test_bb_mqtt_suspend_default_stop_only_no_handle_is_safe);
    RUN_TEST(test_bb_mqtt_resume_default_stop_only_no_handle_is_safe);
    RUN_TEST(test_bb_mqtt_host_last_pub_null_handle_returns_null);
    RUN_TEST(test_bb_mqtt_host_pub_count_null_handle_returns_zero);
    RUN_TEST(test_bb_mqtt_host_last_uri_null_handle_returns_empty);
    RUN_TEST(test_bb_mqtt_host_set_connected_null_handle_is_safe);
    RUN_TEST(test_bb_mqtt_host_reset_null_handle_is_safe);
    RUN_TEST(test_bb_mqtt_host_set_subscribe_fail_null_handle_is_safe);
    ...
    RUN_TEST(test_bb_mqtt_on_message_second_registration_reuses_existing_buffer);
    RUN_TEST(test_bb_mqtt_on_message_alloc_failure_returns_no_space);
    RUN_TEST(test_bb_mqtt_inject_fragment_null_handle_is_safe);
    RUN_TEST(test_bb_mqtt_inject_fragment_null_topic_is_safe);
    ...
    RUN_TEST(test_bb_tcp_client_resolve_tls_creds_plaintext_is_noop);
    RUN_TEST(test_bb_tcp_client_resolve_tls_creds_nvs_used_when_cfg_pem_null);
    RUN_TEST(test_bb_tcp_client_resolve_tls_creds_cfg_pem_beats_nvs);
    RUN_TEST(test_bb_tcp_client_resolve_tls_creds_mutual_cfg_pem_beats_nvs);
    RUN_TEST(test_bb_tcp_client_resolve_tls_creds_len_is_content_len_plus_nul);
    RUN_TEST(test_bb_tcp_client_resolve_tls_creds_empty_resolve_is_ok);
    RUN_TEST(test_bb_tcp_client_resolve_tls_creds_null_cfg_returns_invalid_arg);
    RUN_TEST(test_bb_tcp_client_resolve_tls_creds_null_out_returns_invalid_arg);
    ...
    RUN_TEST(test_bb_serialize_arr_of_i64);
    RUN_TEST(test_bb_serialize_arr_of_i64_empty);
    RUN_TEST(test_bb_serialize_arr_of_i64_single);
    RUN_TEST(test_bb_serialize_arr_of_u64);
    RUN_TEST(test_bb_serialize_arr_of_u64_empty);
    RUN_TEST(test_bb_serialize_arr_of_u64_single);
    RUN_TEST(test_bb_serialize_arr_of_f64);
    RUN_TEST(test_bb_serialize_arr_of_f64_empty);
    RUN_TEST(test_bb_serialize_arr_of_f64_single);
    RUN_TEST(test_bb_serialize_arr_of_bool);
    RUN_TEST(test_bb_serialize_arr_of_bool_empty);
    RUN_TEST(test_bb_serialize_arr_of_bool_single);
    ...
    RUN_TEST(test_bb_serialize_console_two_level_nesting_joins_full_path);
    RUN_TEST(test_bb_serialize_console_sibling_objects_disambiguate_shared_child_key);
    RUN_TEST(test_bb_serialize_console_deep_nesting_under_cap_joins_full_path);
    RUN_TEST(test_bb_serialize_console_nested_key_truncates_cleanly);
    RUN_TEST(test_bb_serialize_console_array_of_obj_row_qualifies_without_row_key);
    ...
    RUN_TEST(test_bb_serialize_console_tasks_gather_rejects_null_dst);
    RUN_TEST(test_bb_serialize_console_tasks_gather_rejects_zero_cap);
    RUN_TEST(test_bb_serialize_console_tasks_gather_empty_registry_yields_zero_rows);
    RUN_TEST(test_bb_serialize_console_tasks_gather_computes_used_bytes_when_budget_known);
    RUN_TEST(test_bb_serialize_console_tasks_gather_clamps_used_bytes_when_free_exceeds_budget);
    RUN_TEST(test_bb_serialize_console_tasks_gather_marks_unsampled_task_unsampled);
    RUN_TEST(test_bb_serialize_console_tasks_gather_truncates_at_cap);
    RUN_TEST(test_bb_serialize_console_tasks_row_desc_matches_snap_layout);
    ...
    RUN_TEST(test_bb_diag_boot_topic_schema_default_matches_relocated_literal);
    RUN_TEST(test_bb_health_stack_topic_schema_default_matches_relocated_literal);
    RUN_TEST(test_bb_log_event_line_topic_schema_default_matches_relocated_literal);
    ...
    RUN_TEST(test_bb_data_gather_plain_calls_fill_and_returns_its_value);
    RUN_TEST(test_bb_data_gather_plain_null_args_returns_invalid_arg);
    RUN_TEST(test_bb_data_gather_plain_null_ctx_returns_invalid_arg);
    RUN_TEST(test_bb_data_gather_plain_null_fill_returns_invalid_arg);
    RUN_TEST(test_bb_data_bind_gather_plain_null_ctx_rejected);
    RUN_TEST(test_bb_data_bind_gather_plain_null_fill_rejected);
    RUN_TEST(test_bb_data_render_gather_plain_delivers_fill_values);
    ...
    RUN_TEST(test_bb_data_http_attach_sized_oversized_snap_size_null_key_does_not_crash);
    ...
    RUN_TEST(test_bb_data_http_client_acquire_null_cfg_returns_invalid_arg);
    ...
    RUN_TEST(test_bb_data_http_client_acquire_blocking_budget_rejects_over_budget);
    RUN_TEST(test_bb_data_http_client_acquire_non_blocking_succeeds_when_blocking_budget_exhausted);
    RUN_TEST(test_bb_data_http_client_acquire_blocking_scan_skips_non_blocking_clients);
    RUN_TEST(test_bb_data_http_client_acquire_reservation_blocks_concurrent_budget_race);
    RUN_TEST(test_bb_data_http_client_acquire_reservation_skipped_by_non_blocking_free_slot_scan);
    RUN_TEST(test_bb_data_http_client_acquire_release_frees_blocking_budget);
    RUN_TEST(test_bb_data_http_client_acquire_omitted_non_blocking_counts_as_blocking);
    ...
    RUN_TEST(test_bb_data_http_client_acquire_topic_filter_too_long_returns_invalid_arg);
    ...
    RUN_TEST(test_bb_data_http_push_pump_called_twice_directly_feeds_ring_twice);
    RUN_TEST(test_bb_data_http_push_pump_n_sequential_bumps_feed_n_distinct_entries);
    RUN_TEST(test_bb_data_http_push_pump_twice_then_sweep_step_delivers_both_in_order);
    ...
    RUN_TEST(test_bb_data_http_sweep_step_send_failure_retriable_leaves_frame_queued_and_retries_next_sweep);
    RUN_TEST(test_bb_data_http_sweep_step_send_failure_retriable_does_not_retry_within_same_sweep);
    RUN_TEST(test_bb_data_http_sweep_step_send_failure_retriable_bound_exceeded_drops_frame);
    RUN_TEST(test_bb_data_http_sweep_step_send_failure_retriable_bound_exceeded_does_not_attempt_next_frame_same_sweep);
    RUN_TEST(test_bb_data_http_sweep_step_send_failure_fatal_invokes_abort_fn);
    RUN_TEST(test_bb_data_http_sweep_step_send_failure_fatal_without_abort_fn_releases_client);
    RUN_TEST(test_bb_data_http_sweep_step_send_failure_fatal_uses_per_client_abort_fn_over_global);
    RUN_TEST(test_bb_data_http_sweep_step_send_failure_fatal_durable_survives_and_retains_outbound);
    RUN_TEST(test_bb_data_http_sweep_step_send_failure_fatal_durable_delivers_retained_frame_on_next_sweep);
    RUN_TEST(test_bb_data_http_sweep_step_send_failure_retriable_ignores_lifetime);
    RUN_TEST(test_bb_data_http_client_request_release_defers_actual_release_to_next_sweep);
    RUN_TEST(test_bb_data_http_sweep_step_reaps_client_only_on_sweep_after_mid_sweep_release_request);
    RUN_TEST(test_bb_data_http_sweep_step_render_failure_retries_on_next_sweep);
    RUN_TEST(test_bb_data_http_cadence_zero_min_interval_renders_every_sweep);
    RUN_TEST(test_bb_data_http_cadence_gate_blocks_until_due_then_renders_once);
    RUN_TEST(test_bb_data_http_cadence_fresh_client_renders_immediately_on_connect_low_clock);
    RUN_TEST(test_bb_data_http_cadence_fresh_client_renders_immediately_on_connect_high_clock);
    RUN_TEST(test_bb_data_http_cadence_fresh_client_renders_immediately_on_connect_real_clock);
    RUN_TEST(test_bb_data_http_cadence_render_failure_while_due_leaves_next_due_ms_unchanged_and_retries);
    RUN_TEST(test_bb_data_http_cadence_attach_over_cap_min_interval_rejected);
    RUN_TEST(test_bb_data_http_cadence_attach_over_cap_min_interval_null_key_does_not_crash);
    RUN_TEST(test_bb_data_http_cadence_no_render_fn_advances_next_due_ms);
    ...
    RUN_TEST(test_bb_data_http_push_only_client_has_null_poll_and_drains_correctly);
    RUN_TEST(test_bb_data_http_poll_only_client_has_null_push_and_drains_correctly);
    RUN_TEST(test_bb_data_http_poll_push_is_null_for_test_null_client_returns_true);
    RUN_TEST(test_bb_data_http_client_acquire_poll_pool_exhausted_returns_no_space);
    RUN_TEST(test_bb_data_http_client_acquire_push_pool_exhausted_returns_no_space);
    RUN_TEST(test_bb_data_http_init_max_poll_clients_over_cap_returns_invalid_arg);
    RUN_TEST(test_bb_data_http_init_max_push_clients_over_cap_returns_invalid_arg);
    ...
    RUN_TEST(test_bb_data_http_host_frame_key_at_out_of_range_returns_not_found);
    RUN_TEST(test_bb_data_http_host_frame_key_at_null_buf_is_optional);
    RUN_TEST(test_bb_data_http_sweep_step_delivers_to_multiple_independent_send_fn_consumers);
    RUN_TEST(test_bb_data_http_sweep_step_client_with_no_send_fn_override_uses_module_wide_default);
    RUN_TEST(test_bb_data_http_sweep_step_client_with_no_send_seam_and_queued_frames_warns_once);
    RUN_TEST(test_bb_data_http_sweep_step_client_with_no_send_seam_and_empty_queue_does_not_warn);
    RUN_TEST(test_bb_data_http_sweep_step_client_with_no_send_seam_recovers_once_module_wide_installed);
    RUN_TEST(test_bb_data_http_sweep_step_client_with_per_client_send_fn_never_warns);
    RUN_TEST(test_bb_data_http_client_acquire_resets_warned_no_send_fn_on_slot_reuse);
    RUN_TEST(test_bb_data_http_mqtt_shaped_client_acquires_and_delivers_with_no_socket_field);
