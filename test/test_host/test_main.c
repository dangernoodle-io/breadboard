...
int main(void) {
    ...
    RUN_TEST(test_bb_wdt_derive_idle_mask_zero_zero);
    RUN_TEST(test_bb_wdt_derive_idle_mask_kconfig_only);
    RUN_TEST(test_bb_wdt_derive_idle_mask_claimed_only);
    RUN_TEST(test_bb_wdt_derive_idle_mask_union_never_overrides);
    RUN_TEST(test_bb_wdt_derive_idle_mask_both_same_bit_is_idempotent);
    RUN_TEST(test_bb_wdt_derive_idle_mask_both_full);
    RUN_TEST(test_bb_wdt_clamp_idle_mask_dual_core_unchanged);
    RUN_TEST(test_bb_wdt_clamp_idle_mask_unicore_drops_bit1);
    RUN_TEST(test_bb_wdt_clamp_idle_mask_unicore_only_bit1_clamps_to_zero);
    RUN_TEST(test_bb_wdt_clamp_idle_mask_zero_cores_clamps_to_zero);
    RUN_TEST(test_bb_wdt_clamp_idle_mask_negative_cores_clamps_to_zero);
    RUN_TEST(test_bb_wdt_clamp_idle_mask_large_num_cores_unchanged);
