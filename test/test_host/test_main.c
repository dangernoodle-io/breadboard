...
int main(void) {
    ...
    RUN_TEST(test_sse_schema_net_health_payload_valid);
    RUN_TEST(test_sse_schema_net_health_payload_missing_required_fails);
    ...
    RUN_TEST(test_bb_net_health_classify_egress_gw_unreachable_below_threshold_is_ok);
    RUN_TEST(test_bb_net_health_classify_egress_gw_unreachable_at_threshold);
    RUN_TEST(test_bb_net_health_classify_egress_gw_reachable_none_failing);
    RUN_TEST(test_bb_net_health_classify_egress_gw_reachable_one_endpoint_down);
    RUN_TEST(test_bb_net_health_classify_egress_gw_reachable_all_endpoints_down);
    RUN_TEST(test_bb_net_health_classify_egress_gw_reachable_no_egress_clients);
    RUN_TEST(test_bb_egress_state_str_ok);
    RUN_TEST(test_bb_egress_state_str_endpoint_down);
    ...
    RUN_TEST(test_bb_net_health_should_request_recovery_act_off_is_always_false);
    RUN_TEST(test_bb_net_health_should_request_recovery_act_on_edge_is_true);
    RUN_TEST(test_bb_net_health_should_request_recovery_act_on_no_edge_is_false);
    RUN_TEST(test_bb_net_health_should_request_recovery_sustained_is_false);
    RUN_TEST(test_bb_net_health_should_reboot_not_unhealthy_is_false);
    RUN_TEST(test_bb_net_health_should_reboot_below_threshold_is_false);
    RUN_TEST(test_bb_net_health_should_reboot_at_threshold_is_true);
    RUN_TEST(test_bb_net_health_should_reboot_within_min_interval_is_false);
    RUN_TEST(test_bb_net_health_should_reboot_min_interval_elapsed_is_true);
    RUN_TEST(test_bb_net_health_should_reboot_never_rebooted_bypasses_min_interval);
    RUN_TEST(test_bb_net_health_should_reboot_daily_cap_exhausted_is_false);
    RUN_TEST(test_bb_net_health_should_reboot_daily_cap_excludes_stale_entries);
    RUN_TEST(test_bb_net_health_should_reboot_all_met_true);
    RUN_TEST(test_bb_net_health_should_reboot_ring_count_over_cap_is_clamped);
    RUN_TEST(test_bb_net_health_should_reboot_ring_entry_future_timestamp_excluded);
    RUN_TEST(test_bb_net_health_should_reboot_clock_skew_unhealthy_since_no_underflow);
    RUN_TEST(test_bb_net_health_should_reboot_clock_skew_last_reboot_no_underflow);
    RUN_TEST(test_bb_net_health_should_reboot_null_state_is_false);
    RUN_TEST(test_bb_net_health_reboot_state_record_appends);
    RUN_TEST(test_bb_net_health_reboot_state_record_null_state_is_safe);
    RUN_TEST(test_bb_net_health_reboot_state_record_wraps_at_cap);
    RUN_TEST(test_bb_net_health_reboot_state_record_24h_old_excluded_from_count);
    RUN_TEST(test_bb_net_health_reboot_state_encode_decode_round_trip_zero_state);
    RUN_TEST(test_bb_net_health_reboot_state_encode_decode_round_trip_partial_ring);
    RUN_TEST(test_bb_net_health_reboot_state_encode_decode_round_trip_ring_wrap);
    RUN_TEST(test_bb_net_health_reboot_state_encode_null_state_is_false);
    RUN_TEST(test_bb_net_health_reboot_state_encode_null_buf_is_false);
    RUN_TEST(test_bb_net_health_reboot_state_encode_buf_too_small_is_false);
    RUN_TEST(test_bb_net_health_reboot_state_encode_zero_buf_len_is_false);
    RUN_TEST(test_bb_net_health_reboot_state_encode_buf_too_small_mid_ring_is_false);
    RUN_TEST(test_bb_net_health_reboot_state_decode_null_str_is_false);
    RUN_TEST(test_bb_net_health_reboot_state_decode_empty_str_is_false);
    RUN_TEST(test_bb_net_health_reboot_state_decode_null_out_is_false);
    RUN_TEST(test_bb_net_health_reboot_state_decode_malformed_is_false);
    RUN_TEST(test_bb_net_health_reboot_state_decode_wrong_ring_length_is_false);
    RUN_TEST(test_bb_net_health_reboot_state_decode_ring_head_out_of_range_is_false);
    RUN_TEST(test_bb_net_health_reboot_state_decode_ring_count_out_of_range_is_false);
    RUN_TEST(test_bb_net_health_reboot_state_decode_malformed_ring_entry_is_false);
    ...
    RUN_TEST(test_bb_ota_check_publish_initial_populates_ring);
    ...
    RUN_TEST(test_bb_event_routes_pool_not_created_until_first_acquire);
    RUN_TEST(test_bb_event_routes_pool_alloc_fails_returns_no_space);
    RUN_TEST(test_bb_event_routes_pool_ensure_idempotent_across_repeated_acquires);
    ...
    RUN_TEST(test_bb_cache_post_null_key_returns_invalid_arg);
    RUN_TEST(test_bb_cache_post_unknown_key_returns_not_found);
    RUN_TEST(test_bb_cache_post_serialize_locked_error_propagates);
    RUN_TEST(test_bb_cache_post_data_obj_alloc_failure_returns_no_space);
    RUN_TEST(test_bb_cache_post_root_obj_alloc_failure_returns_no_space);
    RUN_TEST(test_bb_cache_post_serialize_failure_returns_no_space);
    RUN_TEST(test_bb_cache_serialize_into_null_args_return_invalid_arg);
    RUN_TEST(test_bb_cache_post_serialized_null_args_return_invalid_arg);
    RUN_TEST(test_bb_cache_post_serialized_unknown_key_returns_not_found);
    RUN_TEST(test_bb_cache_post_serialized_no_sse_returns_invalid_state);
    ...
    RUN_TEST(test_bb_cache_post_serialized_delete_race_never_crashes);
