...
void test_prov_parse_empty_body(void)
{
    ...
    bb_wifi_prov_parse_result_t result = bb_wifi_prov_parse_body("", 0, ssid, sizeof(ssid), pass, sizeof(pass));
...
void test_prov_parse_missing_ssid(void)
{
    ...
    bb_wifi_prov_parse_result_t result = bb_wifi_prov_parse_body(body, strlen(body), ssid, sizeof(ssid), pass, sizeof(pass));
